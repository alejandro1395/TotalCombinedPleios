...
WHERE R2 >= 0.8 AND (GroupA IN ('eye disease') OR GroupB IN ('eye disease')) AND CHR != '' ;" > /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/pleios.txt

	### Construct haplotypes with plink
	cat /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/pleios.txt | while read line; do
   	 snpA=$(echo "$line" | cut -f 1);
   	 chr=$(echo "$line" | cut -f 12);
   	 echo $snpA;
   	 snpB=$(echo "$line" | cut -f 6);
   	 echo -e '*' ${snpA}'\t'${snpB} > /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/snps.hlist;
   	 sed -i -e 's/ /\t/g' /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/snps.hlist;
   	 /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/InfecPleiotropies_Apr2019/data/RAW_PROJECT/tests/PairPleiotropies/bin/plink-1.07-x86_64/plink --file /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/InfecPleiotropies_Apr2019/data/RAW_PROJECT/tests/PairPleiotropies/data/VCF_1000G/chr${chr}_CEU_genotypes --hap /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/snps.hlist --hap-freq --noweb --out /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/${snpA}_${snpB};
	grep -v LOCUS /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/${snpA}_${snpB}.frq.hap | awk '{print $2,$3}' > /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Alone/eye/${snpA}_${snpB}.fhtp
	done
