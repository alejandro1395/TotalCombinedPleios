...
### Python script to count pleiotropies in haplotypes
        ...
        python3 ./countPleiotropies.py /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Combination/skeletal_endocrine/${snpA}_${snpB}.fhtp ${n} ${riskHap} ${snpA} "${nameA}" ${RiskAllA} ${PosA} ${OnsetA} ${snpB} "${nameB}" ${RiskAllB} ${PosB} ${OnsetB} ${chr} /homes/users/avalenzuela/scratch/PhD_EvoGenomics/1st_year/StratiPleios_Sep2019/results/Combination/skeletal_endocrine/Age_threeshold_${n}/;
    done; done;
